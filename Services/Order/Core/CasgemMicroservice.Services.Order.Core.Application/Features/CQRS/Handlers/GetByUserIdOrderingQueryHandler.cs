...
{
    public class GetByUserIdOrderingQueryHandler : IRequestHandler<GetByUserIdOrderingQueryRequest, List<ResultOrderingDTO>>
    {
        private readonly IRepository<Ordering> _repository;
        private readonly IMapper _mapper;

        public GetByUserIdOrderingQueryHandler(IRepository<Ordering> repository, IMapper mapper)
        {
